 ...
 * @see https://v0.dev/t/W3PeFUyNEel
...
import { TimeEasyOff } from "./TimeEasyOff";
        ...
        <header className="flex h-14 items-center gap-4 border-b bg-gray-100/40 px-6 dark:bg-gray-800/40">
          ...
          <div className="w-full flex-1">
            <form>
              <div className="relative">
                ...
                <Input
                  className="w-full bg-gray-100/50 shadow-none appearance-none pl-8 md:w-2/3 lg:w-1/3 dark:placeholder-gray-300/50 dark:bg-gray-800/50 dark:placeholder-gray-700/50"
                  placeholder="Search"
                  type="search"
                /> */}
              </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                className="rounded-full border border-gray-200 w-8 h-8 dark:border-gray-800 bg-stone-400"
                size="icon"
                variant="ghost"
              >
